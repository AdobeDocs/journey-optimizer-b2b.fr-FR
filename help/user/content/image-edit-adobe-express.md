...
Le [Guide de l’utilisateur d’](https://helpx.adobe.com/fr/express/web.html){target="_blank"} fournit des informations détaillées sur les fonctionnalités de modification disponibles.
