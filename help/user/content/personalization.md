...
>[!NOTE]
>
>Les informations suivantes concernant l’éditeur de personnalisation reflètent les modifications disponibles pour les environnements Journey Optimizer B2B edition configurés sur l’[architecture simplifiée](../simplified-architecture.md).
