...
>abstract="Utilisez **Adobe Journey Optimizer B2B Edition** pour adapter vos messages à chaque destinataire spécifique en utilisant les données et informations que vous possédez à son sujet. Il peut s’agir de leur prénom, de leur secteur d’activité, de leur titre et plus encore."

[!DNL Adobe Journey Optimizer B2B Edition] fonctionnalités de personnalisation vous permettent d’adapter vos e-mails à chaque destinataire spécifique en exploitant les données et informations dont vous disposez à son sujet. Il peut s’agir de leur prénom, de leur secteur d’activité, de leur titre et plus encore.
...
![Éditeur &#x200B;](./assets/personalization-editor.png){width="800" zoomable="yes"}
...
![Code validé par l’éditeur &#x200B;](./assets/personalization-editor-validated.png){width="500"}
...
Lorsque vous définissez une personnalisation à l’aide d’objets personnalisés, vous pouvez accéder à toutes les variables des objets accessibles par script dans les **[!UICONTROL jetons]** (personne/prospect, compte, système et Mes jetons) et les **[!UICONTROL objets personnalisés]** (schémas relationnels). Lorsque des objets personnalisés sont sélectionnés, vous pouvez afficher les champs en cliquant sur le dossier d’objets personnalisés. Cliquez sur **+** pour chaque champ que vous souhaitez ajouter à l’expression.
