...
| Type | Paramètres | Description |
| ---- | -------- | ----------- |
| [!UICONTROL Line] | ![Paramètres de ligne du séparateur](./assets/email-theme-divider-settings-line.png){width="300"} | Définissez le **[!UICONTROL Style de bordure]** en choisissant une valeur dans la liste des valeurs de `border-style` CSS standard, telles que _Continu_, _Pointillé_ et _Tiret_. |
