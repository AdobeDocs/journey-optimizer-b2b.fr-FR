...
| [!UICONTROL  E-mail opérationnel ] | Cochez la case si vous souhaitez désigner l’e-mail comme opérationnel. Les e-mails opérationnels sont exclus des listes de désinscription et des limites de communication. Sélectionnez cette option uniquement lorsque le destinataire ne peut pas considérer l’e-mail comme un message commercial non sollicité (SPAM). Pour plus d’informations sur l’évaluation des préférences de consentement des e-mails au moment de la diffusion, voir [ Préférences de consentement ](./channels-consent-preferences.md). |
