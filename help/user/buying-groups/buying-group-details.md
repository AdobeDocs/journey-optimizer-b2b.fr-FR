...
description: Affichez les détails du groupe d’achats avec des informations optimisées par l’IA, gérez les rôles des membres, suivez les scores d’engagement et analysez les données d’intention dans Journey Optimizer B2B edition.
