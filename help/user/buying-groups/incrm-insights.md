...
description: Consultez les données des groupes d’achat directement dans Salesforce pour optimiser les opportunités de vente
...
Les Insights dans le CRM sont disponibles dans Salesforce via le lanceur d’application.

1. Cliquez sur le lanceur d’application dans Salesforce.
1. Sélectionnez ou recherchez des `Journey Optimizer B2B Edition`.
1. Dans l’onglet qui s’ouvre, connectez-vous avec vos informations d’identification Adobe.
1. Sélectionnez un sandbox qui héberge vos Parcours de compte dans la liste déroulante.
