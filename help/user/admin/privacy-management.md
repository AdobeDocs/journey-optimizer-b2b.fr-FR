...
Vous pouvez soumettre des requêtes individuelles pour accéder aux données des clients et les supprimer de [!DNL Adobe Journey Optimizer B2B Edition] de deux manières :
...
[!DNL Journey Optimizer B2B Edition] outils de confidentialité vous aident à vous conformer à la réglementation par le biais de [!DNL Privacy Service]. Chaque règlement s’applique si vous détenez des données pour les personnes qui résident dans la région associée.
...
[!DNL Journey Optimizer B2B Edition] prend en charge deux types de demandes d’accès à des informations personnelles :
...
Pour afficher les traitements de demande d&#39;accès à des informations personnelles dans [!DNL Journey Optimizer B2B Edition], développez **[!UICONTROL Confidentialité]** et sélectionnez **[!UICONTROL Demandes]**.
...
1. Sélectionnez **[!UICONTROL Créer une demande]**.

1. Pour le **[!UICONTROL Type de traitement]**, sélectionnez le type de traitement :

   * **[!UICONTROL Accès]**

     Lorsque vous soumettez une demande d’**_accès_** qui comprend des [!DNL Journey Optimizer B2B Edition], [!DNL Privacy Service] renvoie :

     * [!DNL Marketo Engage] activité associée au prospect.
     * [!DNL Journey Optimizer B2B Edition] activité associée à la personne ou au compte.

   * **[!UICONTROL Supprimer]**

     Lorsque vous soumettez une demande **delete** pour [!DNL Marketo Engage] et [!DNL Journey Optimizer B2B Edition], les enregistrements suivants sont supprimés :

     * Lead associé dans [!DNL Marketo Engage].
     * Enregistrements de compte et de personne créés dans [!DNL Journey Optimizer B2B Edition].
     * Historique des conversations de l’assistant AI qui fait référence aux informations personnelles de la personne.
...
1. Pour soumettre la demande, sélectionnez **[!UICONTROL Créer]**.
