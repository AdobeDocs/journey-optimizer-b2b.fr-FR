...
1. Sélectionnez les **[!UICONTROL types d’événement]** à utiliser pour la définition de l’événement.
   ...
   Les [types d’événement](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/classes/experienceevent#eventType) que vous sélectionnez déterminent les événements disponibles en tant que contraintes pour un nœud _Écouter un événement_ dans un parcours de compte.
