...
1. Dans un parcours, un marketeur utilise les événements configurés de l&#39;une des deux façons suivantes :
   ...
   * Ajoute un nœud _Écouter un événement_ et [sélectionne un événement d’expérience](../journeys/listen-for-event-nodes.md#experience-events-account-people) pour déclencher la progression du parcours en fonction de l’activité d’événement en temps réel au cours du parcours.
   * Ajoute un nœud _Fractionner les chemins par personnes_ et configure un chemin d’accès pour [filtrer sur un événement](../journeys/split-merge-paths-nodes.md#experience-event-history-filtering) à partir du dossier **[!UICONTROL Historique des événements]**.

>[!BEGINSHADEBOX]

## Instructions et restrictions {#guidelines-and-limitations}
...
### Filtrer la liste des événements {#filter-the-event-list}
...
1. Cliquez sur **[!UICONTROL Modifier les champs]** pour ouvrir la boîte de dialogue _[!UICONTROL Sélectionner des champs]_ et ajouter d’autres champs.
   ...
   Vous ne pouvez pas supprimer des champs précédemment sélectionnés après la publication d’un parcours qui utilise cet événement.

1. Cliquez sur **[!UICONTROL Sélectionner]** pour enregistrer vos sélections.

### Supprimer un événement {#remove-an-event}

Pour empêcher l’utilisation d’un événement d’expérience dans un nœud _Écouter un événement_ au sein d’un parcours, supprimez l’événement . Vous ne pouvez pas supprimer un événement si un parcours dont le statut est _Planifié_, _En ligne_ ou _Terminé_ l’utilise.

1. Cliquez sur l’icône _Plus_ ( **...** ) en regard du nom de l’événement et choisissez **[!UICONTROL Supprimer]**.

1. Dans la boîte de dialogue de confirmation, cliquez sur **[!UICONTROL Supprimer]**.

   ![Confirmer la suppression de l’événement](./assets/configurations-xdm-events-remove.png){width="500" zoomable="yes"}
...
| Clé source de l’e-mail | `directMarketing.emailSent.mailingKey.sourceKey` |
...
### E-mail remis au destinataire {#email-delivered}
...
### E-mail sur lequel l’utilisateur a cliqué {#email-clicked}
...
### E-mail renvoyé provisoirement {#email-bounced-soft}
...
### E-mail désinscrit {#email-unsubscribed}
...
### Visite de page web {#visit-web-page}
...
### Formulaire rempli {#form-filled-out}
...
### Lien web sur lequel l’utilisateur a cliqué {#web-link-clicked}
