...
description: 'Accédez à Journey Optimizer B2B Edition et parcourez des pages d’accueil personnalisées : différentes vues pour les responsables marketing et les équipes d’administration, avec un accès rapide et un Assistant IA.'
feature: Home Page
role: Admin, User
...
Lorsque vous vous connectez à Adobe Experience Platform et sélectionnez l’application Adobe Journey Optimizer B2B Edition, la page d’accueil s’affiche. Cette page présente un aperçu de l’état actuel de vos initiatives B2B Journey Optimizer sous la forme de liens d’accès rapide <!-- refined insights and--> aux ressources appropriées.
...
* **Administrateur ou administratrice – Nouvel utilisateur ou nouvelle utilisatrice** : la page d’accueil _Admin_ d’un nouvel administrateur ou d’une nouvelle administratrice l’aide à se familiariser avec Journey Optimizer B2B Edition et ses fonctionnalités. Elle comprend une présentation guidée permettant au nouveau responsable de l’administration de suivre un parcours d’intégration étape par étape afin de saisir les nuances du système, et de concevoir efficacement des stratégies et des initiatives marketing B2B.
...
La page inclut également l’accès à l’[assistant IA](./ai-coworker/ai-assistant-overview.md), qui permet aux personnes d’obtenir des informations rapides sur des questions ou sujets spécifiques dont elles ont besoin.<!-- and to obtain specific recommendations for their challenges or objectives-->
