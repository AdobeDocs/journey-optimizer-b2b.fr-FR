...
>&gt; <li>Schéma de référence : [Compte B2B - Schéma de compte professionnel XDM](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/schemas/create-schemas-for-b2b-data)
