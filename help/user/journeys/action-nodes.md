...
>[!NOTE]
>
>L’action _[!UICONTROL Modifier la valeur des données du compte]_ est obsolète pour la version 2025.10. _[!UICONTROL Mettre à jour le profil de compte]_ remplace cette action par l’[architecture simplifiée](../simplified-architecture.md).<br/>
>
...
| ------- | ------ | ------------ | ----------- |
| [Journey Optimizer B2B](#journey-optimizer-b2b-actions) | [!UICONTROL Ajouter à une audience client externe] | <li>Parcours de compte <li>Parcours de personne | <li>Sélectionner une audience externe dédiée à la clientèle |
...
| | [!UICONTROL Moment intéressant] | <li>Parcours de compte <li>Parcours de personne | <li>Type <li>Description |
...
| | [!UICONTROL Envoyer un e-mail] | <li>Parcours de compte <li>Parcours de personne | <li>Créer un e-mail |
...
| | [!UICONTROL Supprimer de la liste Marketo] | <li>Parcours de compte <li>Parcours de personne | <li>Nom de la connexion Marketo externe <li>Nom de la liste |

>[!NOTE]
>
>Les actions _[!UICONTROL Modifier la partition des personnes dans Marketo Engage]_ et _[!UICONTROL Modifier le score]_ sont obsolètes pour la version 2025.10 et ne sont pas disponibles sur l’[architecture simplifiée](../simplified-architecture.md) pour Journey Optimizer B2B edition.<br/>
>
...
+++[!UICONTROL Personnaliser l’expérience web] (Beta)

Utilisez cette action pour [créer des expériences personnalisées](../content/web-experiences.md) directement sur votre site web. La fonctionnalité de canal web offre une boîte à outils flexible que vous pouvez utiliser pour améliorer l’engagement avec du contenu web personnalisé.

![Agir - Personnaliser l’expérience web](./assets/node-action-person-personalize-web-experience.png){width="300"}
...
>[!NOTE]
>
>L’action _[!UICONTROL Mettre à jour le profil de la personne]_ remplace l’action _[!UICONTROL Modifier la valeur des données]_ dans l’[architecture simplifiée](../simplified-architecture.md).<br/>
>
