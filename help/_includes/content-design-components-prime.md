...
description: Section réutilisée à propos de l’utilisation de composants et d’éléments de contenu pour la création de contenu dans Journey Optimizer B2B Prime
...
1. Pour commencer la conception de votre contenu, faites glisser un élément du **[!UICONTROL Structures]** et déposez-le sur la zone de travail.
   ...
   Pour plus d’informations sur l’utilisation et la mise en forme de ces composants, voir _[Composants de structure](../prime/content/structure-components.md)_.
...
1. Développez la section **[!UICONTROL Contenu]** et ajoutez autant de composants de contenu que nécessaire dans un ou plusieurs composants de structure.
   ...
   * [Conteneur](../prime/content/content-components.md#container)
   * [Bouton](../prime/content/content-components.md#button)
   * [Texte](../prime/content/content-components.md#text)
   * [Diviseur](../prime/content/content-components.md#divider)
   * [Image](../prime/content/content-components.md#image)
   * [Social](../prime/content/content-components.md#social)
   * [Formulaire](../prime/content/content-components.md#form) (pages de destination uniquement)
