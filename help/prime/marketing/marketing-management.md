...
description: Utilisez Marketing Management dans Journey Optimizer B2B Prime pour planifier des programmes, créer des parcours, gérer des listes de personnes et créer du contenu à partir du panneau de conversation, de l’espace de travail et de l’arborescence des programmes.
...
Le panneau de conversation s’exécute en même temps que votre travail afin que vous puissiez demander à l’[assistant IA](../agents/chat-interface.md) de faire les choses en contexte. L’en-tête du panneau comprend les commandes suivantes :
