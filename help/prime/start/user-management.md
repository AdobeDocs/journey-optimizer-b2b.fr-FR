...
Les autorisations suivantes contrôlent l’accès aux fonctionnalités de configuration des canaux, de gestion de contenu et de parcours des personnes dans [!DNL Journey Optimizer B2B Prime] :
...
Pour fournir une prise en charge des destinations externes dans [!DNL Journey Optimizer B2B Prime], les autorisations suivantes sont requises :
